...
function touch(id?: string) { for (const path of ['/admin/services', '/admin/packages', '/admin/catalog', '/admin', '/admin/tasks', '/admin/jobs', '/services', '/services/ai-business-operator', '/services/ai-ad-creative-studio', '/services/grow-your-audience', '/website-intake', '/get-started']) revalidatePath(path); if (id) revalidatePath(`/admin/services/${id}`); }
